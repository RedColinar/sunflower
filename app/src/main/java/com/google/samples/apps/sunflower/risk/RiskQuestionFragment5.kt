...
import com.google.samples.apps.sunflower.databinding.FragmentRiskQuestion5Binding
import com.google.samples.apps.sunflower.risk.viewmodel.RiskQuestionViewModel

/**
 * Created by panqiang at 2019-11-23
 */
class RiskQuestionFragment5: Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentRiskQuestion5Binding.inflate(inflater, container, false)
