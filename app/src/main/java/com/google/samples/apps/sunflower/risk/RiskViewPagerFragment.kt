...
class RiskViewPagerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentRiskViewPagerBinding = FragmentRiskViewPagerBinding.inflate(inflater, container, false)
    ...
    class RiskViewPagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {
        ...
        override fun createFragment(position: Int): Fragment {
            return when (position) {
                0 -> RiskQuestionFragment(0)
                1 -> RiskQuestionFragment(1)
                2 -> RiskQuestionFragment(2)
                else -> RiskQuestionFragment(0)
            }
        }
    }
}